...
其中特别重要的是Johnson-Lindenstrauss引理，它揭示了高维空间“稀疏”的特性，因而被广泛用于数据压缩. 证明这一引理所用到的概率论技术是\textbf{矩法}\index{矩法}，这是\emph{机器学习理论}\index{机器学习理论}中最为核心的几个技术之一. 因此本章也可以看做机器学习理论的一个引论. 
