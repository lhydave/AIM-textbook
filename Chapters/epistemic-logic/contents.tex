...
\begin{figure}
    \centering
    \includegraphics[scale=0.4]{Slides/Figures/11/cubic-example.png}
\end{figure}
\end{frame}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.5]{Slides/Figures/11/cubic-example-after-father.png}
\end{figure}
\end{frame}
