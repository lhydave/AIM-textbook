...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{Slides/Figures/02/gampling.eps}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{Slides/Figures/02/forward-equation.eps}
\end{figure}
\end{minipage}
\begin{minipage}[t]{0.4\textwidth}
后向方程（往回一步）：
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{Slides/Figures/02/backward-equation.eps}
\end{figure}
\end{minipage}
\end{frame}

\begin{frame}{遍历定理与平稳分布}
\begin{itemize}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{Slides/Figures/02/simple-example.eps}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[height=0.8\textheight]{Slides/Figures/02/STR.eps}
\end{figure}
\end{frame}
...
\end{itemize}
        ...
        v(s) &= \E(G_t|S_t=s) \\
            ...
            &= {\textcolor{mLightBrown}{\mathcal R_s} + \textcolor{mLightGreen}{\gamma \sum_{s'\in \S}\P_{s,s'}v(s')}}. % HW: 做一下破产博弈的Wald等式. 看一下zfx应随教材1.10三（100页），可以在题目里直接假设停时概率1有限
    \end{align*}
\end{itemize}
\end{frame}

\begin{frame}{矩阵形式的Bellman方程}
\begin{itemize}
...
\begin{frame}{例子：学生MDP}
\begin{figure}
    \centering
    \includegraphics[height=0.8\textheight]{Slides/Figures/02/STD.eps}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{Slides/Figures/02/HMM.eps}
\end{figure}
\end{frame}
...
\begin{frame}{平滑：$\Pr(Z_k = s|X=x, \M)$，$k < t$} 
\begin{itemize}
    \item 回顾：$\alpha_k(s)= \Pr(X_{1:k}=x_{1:k}, Z_k=s| \M)$.
