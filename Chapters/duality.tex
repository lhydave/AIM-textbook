...
对偶函数并不是随手写出来的一个数学游戏，它有着很重要的意义. 我们回到本章开头的抽纸问题，对于乙（即买家），我们可以把最小化买入价这个问题抽象为
...
\begin{remark}
    实际上，这样的想法构成了\emph{射影几何}\index{射影几何}的核心. 在射影几何中，我们把无穷远处的点加入到几何空间中，然后这种几何的性质. 射影几何中，对偶性体如下：任何命题，将点和线的位置互换，该命题仍然成立. 
\end{remark}
