...
\end{corollary}
\begin{proof}
    根据\Cref{cor:kernel-image-isomorphism}，我们有
...
\begin{definition}[正定，半正定，负定，半负定]\label{def:positive-definite}
...
两两正交的基被称为\textbf{正交基}，如果正交基的每个向量都是单位向量，那么称为\textbf{标准正交基}. 在内积空间中，基存在性定理（\Cref{thm:existence-of-basis}）可以被加强为标准正交基存在性定理：
