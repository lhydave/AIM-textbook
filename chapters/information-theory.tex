...
% 机器学习中编码器和解码器的思路，最早是由Rumelhart，Hinton和Williams在 \cite{rumelhartLearningInternalRepresentations1986} 中提出，他们将编码器和解码器的整体称作\textit{自编码器}. 这篇工作几乎可以被视为深度学习的开山之作，它还提出了训练神经网络最常用的反向传播算法.
