...
\begin{enumerate}[wide, labelindent=0pt]
    ...
    \item 考虑关于$n$的正实数序列$a_1(n),\dots,a_k(n)$以及$b_1(n),\dots,b_k(n)$，假设对所有$i$，都成立$\lim_{n\to\infty} a_i(n)/b_i(n)=1$，且$\lim_{n\to\infty}a_i=+\infty$，$a_1(n)-a_2(n)-\dots-a_k(n)>0$. 证明：
    \[\lim_{n\to\infty}\frac{a_1(n)-a_2(n)-\dots-a_k(n)}{b_1(n)-b_2(n)-\dots- b_k(n)}=1.\]
    由此证明式 \eqref{eq:logP}.
