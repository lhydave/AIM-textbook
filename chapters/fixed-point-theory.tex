...
\begin{example}[矩阵范数]\label{ex:matrix-norm}
    ...
    实际上，矩阵的2-范数是一个非常重要的范数，它与矩阵的特征值有密切的关系. 具体来说，根据谱定理（\Cref{thm:symmetric-operator-norm}），如果矩阵$A$是对称的，那么它的2-范数等于它的最大特征值的模. 具体来说，假设$A$的特征值为$\lambda_1,\dots,\lambda_n$，那么
