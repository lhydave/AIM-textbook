...
以上的模态可定义性和\Cref{sec:modal-definability}中的例子类似，这里不再给出，请见习题 \ref{exercise:epistemic-logic-axioms-structure}.
...
作为一个更正式的（也更更复杂！）例子，本节将用模态逻辑的方式来探讨达成一致与共同知识的关系，这个问题最早由Aumann提出. 现代版本的问题是：两个拥有相同决策规则的AI是否会进行交易？如果交易发生，这意味着买家和卖家采取了不同的决策（一个购买，一个出售）；否则，他们将不会达成交易. 
...
\begin{enumerate}[wide, labelindent=0pt]
    ...
    \item *\label{exercise:Aumann-agreement} 查阅资料，叙述并证明由Aumann结构给出的概率版本的Aumann达成一致定理. 
\end{enumerate}
