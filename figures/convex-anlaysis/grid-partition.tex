...
\node[scale=1.5, gray!60] at (3.6,1.5) {$\dots$};
\node[scale=1.5, gray!60] at (-0.6,1.5) {$\dots$};
\node[scale=1.5, rotate=90, gray!60] at (1.5,3.6) {$\dots$};
\node[scale=1.5, rotate=90, gray!60] at (1.5,-0.6) {$\dots$};
\node[scale=1.5, rotate=45, gray!60] at (3.5,3.5) {$\dots$};
\node[scale=1.5, rotate=45, gray!60] at (-0.5,-0.5) {$\dots$};
\node[scale=1.5, rotate=-45, gray!60] at (3.5,-0.5) {$\dots$};
\node[scale=1.5, rotate=-45, gray!60] at (-0.5,3.5) {$\dots$};
